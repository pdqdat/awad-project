...
exports.getUpcomingMovies = async (req, res) => {
    ...
    try {
        const movies = await Movie.find({ categories: "upcoming" }).skip(skip).limit(limit);
...
exports.getTopRatedMovies = async (req, res) => {
    ...
    try {
        const movies = await Movie.find({ categories: "top_rated" }).skip(skip).limit(limit);
...
exports.getPopularMovies = async (req, res) => {
    ...
    try {
        const movies = await Movie.find({ categories: "popular" }).skip(skip).limit(limit);
...
exports.getNowPlayingMovies = async (req, res) => {
    ...
    try {
        const movies = await Movie.find({ categories: "now_playing" }).skip(skip).limit(limit);
